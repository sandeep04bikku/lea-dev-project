...
const AddCourse = () => {
    ...
    const initialValues = useMemo(() => {
        return {
            ...
            file: null,
            image: null,
            language: "", // Single value for selected language
        };
    }, []);
    ...
    return (
        <>
            <Helmet>
                <title>LEA.TRAINING | Course | Add</title>
            </Helmet>
                    ...
                    <div className="col-md-12 col-xl-8 mt-4">
                        <div className="widget-rounded-circle card">
                            <div className="card-body">
                                ...
                                >
                                    <div>
                                        <h2 className="text-align-center">Add Course Details</h2>
                                    </div>
                                </div>
                                <div className="row">
                                    <Formik
                                    ...
                                    >
                                        {({ isSubmitting, setFieldValue, submitCount, errors, values, handleBlur }) => {
                                            return (
                                                <Form>
                                                    <div className="mb-3 text-center">
                                                        ...
                                                        <input
                                                            ...
                                                            name="image"
                                                            ref={imageFileRef}
                                                            className={`form-control ${submitCount > 0 && errors.image ? "is-invalid" : ""
                                                                } d-none`}
                                                            accept="image/*"
                                                    ...
                                                    <div className="mb-3">
                                                        <label htmlFor="language" className="form-label">
                                                            <sup style={{ color: "red", fontSize: "12px", fontWeight: "lighter" }}><span>*</span></sup>Language
                                                        </label>
                                                        <Field
                                                            as="select"
                                                            name="language"
                                                    ...
                                                    <div className="mb-3">
                                                        <label htmlFor="category_id" className="form-label">
                                                            <sup style={{ color: "red", fontSize: "12px", fontWeight: "lighter" }}><span>*</span></sup>Category
                                                        </label>
                                                        <Field
                                                            as="select"
                                                            name="category_id"
                                                    ...
                                                    <div className="mb-3">
                                                        <label htmlFor="name" className="form-label">
                                                            <sup style={{ color: "red", fontSize: "12px", fontWeight: "lighter" }}><span>*</span></sup>Course Name
                                                        </label>
                                                        <Field
                                                            type="text"
                                                            name="name"
                                                    ...
                                                    <div className="mb-3">
                                                        <label htmlFor="description" className="form-label">
                                                            <sup style={{ color: "red", fontSize: "12px", fontWeight: "lighter" }}><span>*</span></sup>Description
                                                        </label>
                                                        <Field
                                                            as="textarea"
                                                            name="description"
                                                    ...
                                                    <div className="mb-3">
                                                        <label htmlFor="price" className="form-label">
                                                            <sup style={{ color: "red", fontSize: "12px", fontWeight: "lighter" }}><span>*</span></sup>Price
                                                        </label>
                                                        <Field
                                                            type="text"
                                                            name="price"
                                                    ...
                                                    <div className="mb-3">
                                                        <label htmlFor="file" className="form-label">
                                                            <sup style={{ color: "red", fontSize: "12px", fontWeight: "lighter" }}><span>*</span></sup>Course File
                                                        </label>
                                                        <input
                                                            id="file"
                                                            name="file"
